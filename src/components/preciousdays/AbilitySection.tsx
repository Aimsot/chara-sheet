                    ...
                    >
                      {isReadOnly ? (
                        ...
                        <div className={formStyles.stepper}>
                          ...
                          {/* 数値入力コンポーネント */}
                          <NumberInput
                            onChange={(val) => handleAbilitiesBonusChange(key, val, setErrorInfo)}
                ...
                <div className={`${tableStyles.row} ${tableStyles.readonly}`} style={gridStyle}>
                  <div className={tableStyles.labelCell}>
                    <div className={layoutStyles.flexColumn}>
                      ...
                      {isReadOnly ? (
                        <span>
                          {ELEMENT_DATA[char.element as ElementKey]?.name || char.element}
                        </span>
                      ) : (
                        <select
                          className={formStyles.select}
                          onChange={(e) =>
                            updateAbilities({ element: e.target.value as ElementKey })
                          }
                          style={{ fontSize: '0.8rem', height: '28px', padding: '0 4px' }}
                          value={char.element}
                        >
                    ...
                    <div className={tableStyles.cell} key={key}>
                      {isReadOnly ? (
                        ...
                        <div className={formStyles.stepper}>
                          ...
                          <NumberInput
                            onChange={(val) => handleAbilitiesOtherModifierChange(key, val)}
